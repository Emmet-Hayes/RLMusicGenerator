...
# initializes a majenta model for use as the goal state sequence
...
# generates a sequence to be used as goal states
...
# uses pygame to play audio generated by the MIDI file
...
# strips the features of a midi file to only relevant dimensions
...
# creates a MIDI file from the sequence of states.
...
# maps strings to modifiers for adjusting the starting pitch of a scale
...
# returns a list of scale degrees corresponding to the given scale type
...
# generates a sequence based on the given key and scale
